                ...
                xt.href = ut.href, g.extend({
                    ...
                    ajax: function(e, t) {
                        ...
                        function k(e, t, s, a) {
                            ...
                            }(p, b, C, c), c ? (p.ifModified && ((T = C.getResponseHeader("Last-Modified")) && (g.lastModified[i] = T), (T = C.getResponseHeader("etag")) && (g.etag[i] = T)), 204 === e || "HEAD" === p.type ? k = "nocontent" : 304 === e ? k = "notmodified" : (k = b.state, f = b.data, c = !(x = b.error))) : (x = k, !e && k || (k = "error", e < 0 && (e = 0))), C.status = e, C.statusText = (t || k) + "", c ? v.resolveWith(d, [f, k, C]) : v.rejectWith(d, [C, k, x]), C.statusCode(y), y = void 0, l && h.trigger(c ? "ajaxSuccess" : "ajaxError", [C, p, c ? f : x]), m.fireWith(d, [C, k]), l && (h.trigger("ajaxComplete", [C, p]), --g.IsActivated || g.event.trigger("ajaxStop")))
                        }
                        return C
                    },
