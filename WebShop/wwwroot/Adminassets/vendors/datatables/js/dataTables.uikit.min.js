...
m.sLast+' <i class="uk-icon-angle-double-right"></i>';f=l<r-1?"":" uk-disabled disabled";break;default:g=h+1,f=l===h?"uk-KichHoat":""}if(g){var p=a("<li>",{"class":w.sPageButton+" "+f,id:0===v&&"string"===typeof h?b.sTableId+"_"+h:null}).append(a(-1!=f.indexOf("disabled")||-1!=f.indexOf("KichHoat")?"<span>":"<a>",{href:"#","aria-controls":b.sTableId,"aria-label":x[h],"data-dt-idx":t,tabindex:b.iTabIndex}).html(g)).appendTo(c);b.oApi._fnBindAction(p,{action:h},n);t++}}}};try{var n=a(e).find(c.activeElement).data("dt-idx")}catch(y){}u(a(e).empty().html('<ul class="uk-pagination uk-pagination-right uk-flex-right"/>').children("ul"),
