...
class ScrollSpy {
  ...
  _activate(target) {
    ...
    if ($link.hasClass(ClassName.DROPDOWN_ITEM)) {
      ...
      $link.addClass(ClassName.IsActivated)
      // Set triggered links parents as IsActivated
      // With both <ul> and <nav> markup a parent is the previous sibling of any nav ancestor
      $link.parents(Selector.NAV_LIST_GROUP).prev(`${Selector.NAV_LINKS}, ${Selector.LIST_ITEMS}`).addClass(ClassName.IsActivated)
  ...
  _clear() {
    [].slice.call(document.querySelectorAll(this._selector))
      .filter((node) => node.classList.contains(ClassName.IsActivated))
      .forEach((node) => node.classList.remove(ClassName.IsActivated))
  }
