...
//        public IActionResult PrintQuotation(string code, string FullName, string SoDienThoai, string Email, int ProvinceId, int DistrictId, int WardId, string Address)
//        {
//            var cart = HttpContext.Session.Get<List<CartItem>>("GioHang");
...
//        [HttpPost]
//        [Route("/save-Order")]
//        public IActionResult SaveOrder(string FullName, string SoDienThoai, string Email, int ProvinceId, int DistrictId, int WardId, string Address)
//        {
...
//                            var text = textcover(optionEmail.Body, tk.FullName, tk.Email, tk.SoDienThoai.ToString(), address, "", listO,donhang);
...
//                        {
//                            var optionEmail = _context.EmailMakettings.Where(i => i.EmailEvent == 8).FirstOrDefault();
//                            var text = textcover(optionEmail.Body, tk.FullName, tk.Email, tk.SoDienThoai.ToString(), address1, "", listO, donhang);
//                            email.Bcc.Add(MailboxAddress.Parse(tk.Email));
//                            email.To.Add(MailboxAddress.Parse(tk.Email));
//                            email.Subject = optionEmail.Title;
//                            email.Body = new TextPart(TextFormat.Html) { Text = text };
...
//        public string textcover(string body, string Name, string Email, string SoDienThoai, string Address, string CompannyName, List<OrderDetail> Order, Order donhang)
//        {
