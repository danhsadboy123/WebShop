...
namespace WebShop.Migrations
{
    ...
    public partial class data : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EmailID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AcountID = table.Column<int>(type: "int", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Header = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContentName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Body = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    CustomDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    EmailEvent = table.Column<int>(type: "int", nullable: true),
                    Active = table.Column<int>(type: "int", nullable: true),
                    Input = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmailMaketting", x => x.EmailID);
                    table.ForeignKey(
                        name: "FK_EmailMaketting_Accounts",
                        column: x => x.AcountID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailMaketting_AcountID",
                table: "EmailMaketting",
                column: "AcountID");
