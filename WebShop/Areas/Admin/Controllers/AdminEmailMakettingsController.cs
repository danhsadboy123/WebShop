...
//            ViewBag.Account = _context.TaiKhoans.Where(c => c.AccountId == int.Parse(taikhoanID)).FirstOrDefault();
...
//        public async Task<IActionResult> Create([Bind("EmailId,AcountId,Title,Body,CreatedAt,CustomDate")] EmailMaketting emailMaketting, string url)
//        {
...
//                            var text = textcover(optionEmail.Body, customer.FullName, customer.Email, customer.SoDienThoai.ToString(), address, "");
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<IActionResult> Edit(int id, string url, [Bind("EmailId,AcountId,Title,Body,CreatedAt,CustomDate")] EmailMaketting emailMaketting)
//        {
