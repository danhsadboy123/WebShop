...
namespace WebShop.Areas.Admin.Controllers
{
    ...
    public class AdminCustomerProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Image,Address,MoTa,YearOn,YearOff,Link")] CustomerProject customerProject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Image,Address,MoTa,YearOn,YearOff,Link")] CustomerProject customerProject)
        {
