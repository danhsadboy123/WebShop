...
namespace WebShop.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AccountId,SoDienThoai,Email,Password,Salt,IsActivated,FullName,RoleId,LastLogin,CreatedAt")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AccountId,SoDienThoai,Email,Password,Salt,IsActivated,FullName,RoleId,LastLogin,CreatedAt")] Account account)
        {
