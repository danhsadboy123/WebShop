        ...
        public static async Task SeedingData(CaFeContext _context)
        {
            ...
            if (!_context.SanPhams.Any())
            {
                ...
                await _context.SanPhams.AddRangeAsync(
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại hạt: Arabica, Robusta<br>Độ rang: Medium<br>Khối lượng: 250g<br>Hương vị: Đậm đà, hậu ngọt<br>Phù hợp: Pha phin, pha máy",
                        SoLuong = 50,
                        TrangThai = 1,
                        LuotXem = 1000,
                    ...
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại hạt: Robusta<br>Độ rang: Dark<br>Khối lượng: 500g<br>Hương vị: Đậm, đắng nhẹ<br>Phù hợp: Pha phin",
                        SoLuong = 40,
                        TrangThai = 1,
                        LuotXem = 800,
                        NgayTao = DateTime.Now,
                    ...
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại hạt: Arabica, Robusta<br>Độ rang: Medium-Dark<br>Khối lượng: 500g<br>Hương vị: Cân bằng, hậu ngọt<br>Phù hợp: Pha phin, pha máy",
                        SoLuong = 30,
                        TrangThai = 1,
                        LuotXem = 600,
                        NgayTao = DateTime.Now,
                    ...
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại hạt: Robusta Culi<br>Độ rang: Dark<br>Khối lượng: 500g<br>Hương vị: Đậm, đắng mạnh<br>Phù hợp: Pha phin",
                        SoLuong = 25,
                        TrangThai = 1,
                        LuotXem = 500,
                        NgayTao = DateTime.Now,
                    ...
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại hạt: Robusta<br>Độ rang: Dark<br>Khối lượng: 200g<br>Hương vị: Đậm, béo ngậy<br>Phù hợp: Pha phin",
                        SoLuong = 60,
                        TrangThai = 2,
                        LuotXem = 1200,
                        NgayTao = DateTime.Now,
                    ...
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại hạt: Arabica<br>Độ rang: Light-Medium<br>Khối lượng: 250g<br>Hương vị: Chua thanh, thơm nhẹ<br>Phù hợp: Pha máy, pour-over",
                        SoLuong = 45,
                        TrangThai = 2,
                        LuotXem = 900,
                        NgayTao = DateTime.Now,
                    ...
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại: Cà phê hòa tan<br>Khối lượng: 20 gói x 16g<br>Hương vị: Đậm, ngọt nhẹ<br>Phù hợp: Pha nhanh",
                        SoLuong = 100,
                        TrangThai = 3,
                        LuotXem = 1500,
                        NgayTao = DateTime.Now,
                    ...
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại hạt: Arabica, Robusta<br>Độ rang: Medium<br>Khối lượng: 250g<br>Hương vị: Cân bằng, hậu vị ngọt<br>Phù hợp: Pha phin, pha máy",
                        SoLuong = 35,
                        TrangThai = 3,
                        LuotXem = 700,
                        NgayTao = DateTime.Now,
                    ...
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại hạt: Moka<br>Độ rang: Medium<br>Khối lượng: 250g<br>Hương vị: Chua nhẹ, thơm nồng<br>Phù hợp: Pha máy",
                        SoLuong = 50,
                        TrangThai = 3,
                        LuotXem = 850,
                        NgayTao = DateTime.Now,
                    ...
                    new SanPham
                    {
                        ...
                        ThongSoKyThuat = "Loại: Cà phê hòa tan<br>Khối lượng: 15 gói x 2g<br>Hương vị: Đậm, đắng<br>Phù hợp: Pha nhanh",
                        SoLuong = 80,
                        TrangThai = 3,
                        LuotXem = 1100,
                        NgayTao = DateTime.Now,
            ...
            if (!_context.Sliders.Any())
            {
                await _context.Sliders.AddRangeAsync(
                    new Slider { TieuDe = "Trung Nguyên Legend", MoTa = "Sản Phẩm Nổi Bật", HinhAnh = "https://images.unsplash.com/photo-1519681393784-d120267933ba?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60", Link = "/Product/ProductDetail/3", ThuTuHienThi = 1, TrangThai = true },
                    new Slider { TieuDe = "Highlands Coffee Phin", MoTa = "Giảm giá đến 15%", HinhAnh = "https://images.unsplash.com/photo-1506619216599-9d16d0903a99?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60", Link = "/Product/ProductDetail/5", ThuTuHienThi = 2, TrangThai = true },
                    new Slider { TieuDe = "The Coffee House Blend", MoTa = "Hương vị cân bằng, dễ uống", HinhAnh = "https://images.unsplash.com/photo-1523554889513-87578c1447e1?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=60", Link = "/Product/ProductDetail/8", ThuTuHienThi = 3, TrangThai = true }
                );
                await _context.SaveChangesAsync();
            }
